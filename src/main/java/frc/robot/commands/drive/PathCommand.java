...
public class PathCommand extends SequentialCommandGroup {
  ...
  public PathCommand(DriveBase drivebase, PathPlannerTrajectory traj, boolean isFirstPath) {
    this.driveBase = drivebase;
    this.ramsete = new RamseteController();
    this.leftController = new PIDController(DriveConstants.KP, DriveConstants.KI, DriveConstants.KD);
    this.rightController = new PIDController(DriveConstants.KP, DriveConstants.KI, DriveConstants.KD);
