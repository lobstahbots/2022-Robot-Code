...
public class DampenedMotorController implements MotorController {
  ...
  /*
   * This stores the last calculated speed from the dampener because the SlewRateLimiter
   * doesn't have a way of retrieving this value. 
   * 
  ...
  /**
   * Sets the output of the motor controller, clamped to [-1, 1], and limited by
   * the saved rate limit. 
   * 
   * Must be called regularly if the input speed is far away from the current speed
   * or the rate limit is low. 
   * 
  ...
  /**
   * Inverts the movement direction of the motor controller. Inversion will not
   * take effect until the next time set() is called, and it will respect the 
   * rate limit. 
   */
  @Override
  public void setInverted(boolean isInverted) {
    /* 
     * Inverts the motor controller, and then sets the speed of the motor controller
   ...
   * 
   * Also stops the motor at full speed. This is a safety feature, as disable() is 
   * more explicit than set(0).
   */
  @Override
  public void disable() {
    dampener.reset(0);
  ...
  /**
   * Stops the motor at full speed. This is a safety feature, as stopMotor() is more
   * explicit than set(0).
   */
  @Override
